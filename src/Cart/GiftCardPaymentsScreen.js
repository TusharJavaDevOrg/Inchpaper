...
class GiftCardPaymentsScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isWalletOpen: false,
                            ...
                            <View style={{ backgroundColor: '#fff', padding: 10, elevation: 2, marginTop: 10, marginHorizontal: 5 }}>
                                ...
                                <View style={{ paddingVertical: 5, }}>
                                    <View style={{ flexDirection: 'row', paddingVertical: 5 }}>
                                        ...
                                        <Text style={{ paddingLeft: 5, fontSize: 12, textTransform: 'capitalize', fontFamily: 'sans-serif', textAlign: 'justify' }}>{body.customerName}</Text>
                                    </View>
                                    <View style={{ flexDirection: 'row', paddingBottom: 5 }}>
                                        <Icon name="email" size={15} color={Colors.primary} style={{ paddingTop: 2 }} />
                                        <Text style={{ paddingLeft: 5, fontFamily: 'sans-serif', fontSize: 13 }}>{body?.emailId}</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={{ backgroundColor: '#fff', marginTop: 10, elevation: 2, marginHorizontal: 5 }}>
                            <View style={{}}>
                                ...
                                <View style={{ paddingVertical: 4, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 15 }}>
                                    ...
                                    <Text style={{ fontSize: 13, fontFamily: 'sans-serif-condensed', color: '#7A7A7A' }}>₹ {body.amount}</Text>
                                </View>
                                ...
                                <View style={{ paddingVertical: 10, paddingBottom: 20, backgroundColor: '#defff9' }}>
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 15 }}>
                                        ...
                                        <View>
                                            <Text style={{ fontSize: 14, fontWeight: 'bold', textAlign: 'right' }}>₹ {body.amount}</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(GiftCardPaymentsScreen);
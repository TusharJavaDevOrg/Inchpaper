...
class ProductDetailsScreen extends Component {
    ...
    checkScreen = async () => {
        ...
        if (from === 'productListing') {
            ...
            console.log('product detail', product?.category?.id, product?.subCategory?.id)
    ...
    getCategoriesProducts = async (pageNum, catid, subcatid,) => {
        ...
        // console.log('subsubcategroy params', url)
        ...
        await Axios.get(url, {
            ...
            .then((response) => {
                // console.log("product data ====>  ", JSON.stringify(response.data.object));
                this.setState({
                ...
                // this.props.createDefaultVariants(response.data.object);
                // console.log(" state product data ====>  ", this.state.allProducts);         
            ...
            .catch((error) => {
                ...
                // console.log('Error subsub products', error);
            });
    }
    getProductReview = async (pId) => {
        ...
        Axios.get(url, {
            ...
            // console.log('response of reviews', resp.data.object)
    ...
    getProductUsingNameAndId = async (productId, productName) => {
        ...
        await Axios.get(url, {
            ...
            .then((resp) => {
                ...
                //   resp.data.object[0].productListings,
                // );
                var productListingActiveArr = [];
        ...
        if (this.state.isloading) {
            ...
            if (from === 'Search' || from === 'Cart') {
                ...
                if (this.state.productLoading) {
                    ...
                    product.productListings
                        ? (productMrp =
                            product.productListings[this.state.indexOfSelectedVariant].mrp)
                        : (productMrp = 0);
                        ...
                        <View style={{ flex: 1 }}>
                            ...
                            <View style={{ flex: 1, }}>
                                <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false} onScroll={Animated.event([{ nativeEvent: { contentOffset: { y: scroll } } }])}>
                                    ...
                                    <View style={{ backgroundColor: '#fff' }}>
                                        <View style={{ flexDirection: 'row', alignSelf: 'center', paddingHorizontal: 10, paddingVertical: 10 }}>
                                            {this.props.favourites.products.findIndex(
                                                (it, ind) => it.id === product.id,
                                            ) === -1 ? <TouchableOpacity onPress={() => this.props.addOneFavourite(product)} style={{ padding: 12, backgroundColor: '#E0E0E0', width: '50%' }}>
                                                    <Text style={{ textAlign: 'center', textTransform: 'uppercase', fontWeight: 'bold', color: '#000', fontFamily: 'sans' }}>Add to wishlist</Text>
                                                </TouchableOpacity> : <TouchableOpacity onPress={() => this.props.removeOneFavourite(product.id)} style={{ padding: 12, backgroundColor: '#E0E0E0', width: '50%' }}>
                                                    <Text style={{ textAlign: 'center', textTransform: 'uppercase', fontWeight: 'bold', color: '#000', fontFamily: 'sans' }}>Remove from wishlist</Text>
                                                </TouchableOpacity>}
                                            {this.props.cart.cart.findIndex(
                                                ...
                                                currentItem.indexOfselectedVariant = this.state.indexOfSelectedVariant;
                                                ...
                                                style={{ padding: 12, backgroundColor: Colors.primary, width: '50%' }}>
                                                        ...
                                                        <View
                                                                ...
                                                                <Text style={{ fontSize: 16 }}>
                                                                    {
                                                                        this.props.cart.cart[
                                                                            indexOfProductWithSameIdAndVariantInCart
                                                                        ].productCountInCart
                                                                    }
                                                                </Text>
                                                            </View>
                                                            <TouchableOpacity
                                                                onPress={() => {
                                                                    ...
                                                                    //     ].productCountInCart <
                                                                    //     product.productListings[
                                                                    //       product.productListings.findIndex(
                                                                    //         (x) =>
                                                                    //           x.variantValues[0] ===
                                                                    //           this.props.cart.cart[
                                                                    //             indexOfProductWithSameIdAndVariantInCart
                                                                    //           ].variantSelectedByCustome,
                                                                    //       )
                                                                    //     ].maxOrderQty
                                                                    //   ) {
                                ...
                                this.state.show ? <View>
                                    <View style={{ flexDirection: 'row', }}>
                                        ...
                                        {this.props.cart.cart.findIndex(
                                            ...
                                            await this.props.addOneItemToCart(currentItem);
                                            console.log('cart me add ho', currentItem)
                                            toast('Added To Cart')
                                            this.addAbondonedData();
                                        }}
                                            style={{ padding: 12, backgroundColor: Colors.primary, width: '50%' }}>
                                                ...
                                                <>
                                                    <View
                                                        ...
                                                        <TouchableOpacity
                                                            ...
                                                            <Text style={{ fontSize: 25, color: Colors.white, fontWeight: 'bold' }}>-</Text>
                                                        </TouchableOpacity>
                                                        <View
                                                            style={{
                                                                flex: 1,
